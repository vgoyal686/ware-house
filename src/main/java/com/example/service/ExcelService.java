...
public class ExcelService {
  ...
  public Workbook convertMultipartFileStreamToWorkbook(FileBean fileBean){
  ...
  public Workbook convertFileToWorkbook(String filepath) throws Exception{
    
    FileInputStream file;
    //ByteArrayInputStream bis = new ByteArrayInputStream(file.getFileData().getBytes());
  ...
  public List<TestReport> parseWorkbook(Workbook workbook){
  ...
  public TestReport parseRowToModel(Row row){
    ...
    while(cellIterator.hasNext()) {
        ...
        testReport = new TestReport(barcode, isc, voc, imp, vmp, pmax, carton, pallet, cableLength, connector, countryOfOrigin, currentSorting);
    }
    return testReport;
  }
  
  public String parseCellValueToString(Cell cell){
    String value = null;
