...
public class InputFormBean {
  ...
  public String toString() {
    return "InputFormBean [orderID=" + orderID + ", customerID=" + customerID + ", warehouseID="
        + warehouseID + ", invoiceNo=" + invoiceNo + ", invoiceDate=" + invoiceDate + ", lCNo="
        + lCNo + ", dateOfIssue=" + dateOfIssue + ", customer=" + customer + ", deliveryTerms="
        + deliveryTerms + ", portOfImport=" + portOfImport + ", bLNo=" + bLNo + ", bLDate=" + bLDate
        + ", pONo=" + pONo + ", comments=" + comments + "]";
  }
