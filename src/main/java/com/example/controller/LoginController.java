...
public class LoginController
{
    ...
    @RequestMapping(value = "/inventorystoragedays/customer", method = RequestMethod.GET)
    ...
    /************************************************************ STORAGE CHARGES ***************************************************/
    @RequestMapping(value = "/inventorystoragecharges/customer/list", method = RequestMethod.GET)
